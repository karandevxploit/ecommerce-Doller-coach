...
export const ProductCardSkeleton = memo(function ProductCardSkeleton({
  ...
  return (
    <div
      className={`flex bg-white rounded-xl overflow-hidden border border-slate-200 p-3 ${horizontal ? "flex-row gap-4 h-32 md:h-44" : "flex-col"
        }`}
    >
      <Skeleton
        className={horizontal ? "w-24 md:w-40 h-full shrink-0" : "aspect-[4/5]"}
        rounded="rounded-md"
      />
...
export const OrderSummarySkeleton = memo(function OrderSummarySkeleton() {
  return (
